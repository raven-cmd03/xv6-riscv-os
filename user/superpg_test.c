...
int main(int argc, char *argv[]) {
  char *ptr;
  int size_mb = 4; // Try to allocate 4MB to trigger superpage usage
  int size_bytes = size_mb * 1024 * 1024;
  
  printf("Testing superpage allocation...\n");
  ...
  printf("Superpage test passed - system can allocate large memory regions\n");
